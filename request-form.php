        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <center><h5 class="modal-title" id="exampleModalLabel">Success!</h5></center>
                        ...
                        <div class="container">
                            <div class="row d-flex">
                                <div class="col-md-6 col-lg-5 d-flex ftco-animate" style="max-height: 400px;">
                                    <div class="img w-100 d-flex align-self-lg-auto align-items-center" style="background-image:url(images/register.jpg); background-size: contain;">
                                </div>
                                </div>
                                    ...
                                    <div class="py-md-5">
                                        <div class="row justify-content-start pb-3">
                                            <div class="col-md-12 heading-section ftco-animate p-4 p-lg-5">
                                                <h2 class="mb-4">Thank you for choosing <br><span>Quatro Labs</span></h2>
                                                <p></p>
...
<!-- loader -->
<div id="ftco-loader" class="show fullscreen"><svg class="circular" width="40px" height="40px"><circle class="path-bg" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke="#eeeeee"/><circle class="path" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke-miterlimit="10" stroke="#F96D00"/></svg></div>
